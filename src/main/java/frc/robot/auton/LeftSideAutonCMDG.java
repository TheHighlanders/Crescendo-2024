...
public class LeftSideAutonCMDG extends SequentialCommandGroup {

    public LeftSideAutonCMDG(Swerve swerve, Intake intake, Pivot pivot, Shooter shooter, Localizer localizer) {
        addCommands(
