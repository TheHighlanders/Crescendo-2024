...
public class Intake extends SubsystemBase {
    ...
    public Intake() {
        ...
        pidIntakeController.setOutputRange(Constants.Intake.pidValues.minOut, Constants.Intake.pidValues.maxOut);
        ...
        pidIntakeController.setSmartMotionMinOutputVelocity(Constants.Intake.minVel, Constants.Intake.slotID);
        pidIntakeController.setSmartMotionMaxAccel(Constants.Intake.maxAcc, Constants.Intake.slotID);
        pidIntakeController.setSmartMotionAllowedClosedLoopError(Constants.Intake.allowedErr, Constants.Intake.slotID);
